...
1. **Left Panel** - DNA controls with tabs, output selection, and lyrics input
2. **Main Area** - Artist header with animated waveform and music style cards
3. **Global Player** - Persistent audio player at the bottom
